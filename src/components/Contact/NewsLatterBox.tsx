  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      <div className="space-y-6 text-gray-800 dark:text-white">
        <div>
          <h3 className="mb-1 text-lg font-semibold">📍 Our Location</h3>
          <p>Bhubaneswar, Odisha, India</p>
        </div>

        <div>
          <h3 className="mb-1 text-lg font-semibold">📧 General Enquiries</h3>
          <p>nexheventm@gmail.com</p>
        </div>
        ...
        <div>
          <h3 className="mb-1 text-lg font-semibold">⏰ Our Timing</h3>
